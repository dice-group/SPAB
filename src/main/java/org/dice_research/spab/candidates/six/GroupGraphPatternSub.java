 ...
 * 
 * Each refinement contains one {@link TriplesBlock}.
 * 
 * TODO: Create exact refinements.
 * 
...
public class GroupGraphPatternSub extends Expression {
	...
	public List<Expression> getRefinements(Input input) {
		...
		if (type.equals(Type.INITIAL)) {
			...
			for (Expression graphPatternNotTriples : GraphPatternNotTriples.getInitialInstances()) {
